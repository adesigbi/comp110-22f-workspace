...
if instances_of_character == 1:
    print(str(instances_of_character) + " instance of " + chardle_character + " found in " + chardle_word)
if instances_of_character > 1:
    print(str(instances_of_character) + " instances of " + chardle_character + " found in " + chardle_word) 
